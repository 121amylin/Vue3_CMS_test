...
<template>
    <div>
        <p>
            <n-rate size="small"></n-rate>
        </p>
        <p>
            <n-rate size="medium"></n-rate>
        </p>
        <p>
            <n-rate size="large"></n-rate>
        </p>
        <p><n-rate color="#4fb233" allow-half clearable></n-rate></p>
        <p><n-rate color="#4fb233" readonly :default-value="3"></n-rate></p>
        <p>
            <n-rate>
                <n-icon size="20">
                    <cash-icon />
