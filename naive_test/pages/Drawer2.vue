...
<template>
    ...
    ">
        ...
        <n-drawer v-model:show="active" :width="200" :height="200" :placement="placement" :trap-focus="false"
            :block-scroll="false" to="#drawer-target">
            <n-drawer-content title="斯通纳"  :native-scrollbar="false">
                《斯通纳》是美国作家约翰·威廉姆斯在 1965 年出版的小说。William Stoner is born on a small farm in 1891. One day his father
